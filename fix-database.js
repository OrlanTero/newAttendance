...
const filePath = path.join(__dirname, "api", "database.js");
const outputPath = path.join(__dirname, "api", "database_fixed.js");

console.log("Reading database.js file...");
const data = fs.readFileSync(filePath, "utf8");

// Use regex to extract content from the file
...
console.log("Writing fixed database.js file...");
fs.writeFileSync(outputPath, fixedContent, "utf8");
console.log("Fixed file created at:", outputPath);
console.log("Run the script with: node fix-database.js");
console.log(
  "Then copy the fixed file over the original: copy api\\database_fixed.js api\\database.js"
);
